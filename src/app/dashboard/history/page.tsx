...
import { ArrowLeft, User, LogOut, Package, ClipboardList, TrendingUp, Settings, Activity, Search, Filter, Calendar, Info, Loader2 } from 'lucide-react'
                ...
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-black tracking-tighter text-xl text-white">MoldApp</span>
                        </div>
                    </div>
